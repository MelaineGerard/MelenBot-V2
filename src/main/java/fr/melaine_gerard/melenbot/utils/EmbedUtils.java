...
public class EmbedUtils {
    ...
    public static EmbedBuilder createErrorEmbed(JDA jda, String text) {
        return createEmbed(jda).setColor(Color.RED).setTitle("Erreur !").setDescription(text);
    }

    public static EmbedBuilder createSuccessEmbed(JDA jda, String text) {
        return createEmbed(jda).setColor(Color.GREEN).setTitle("Succès !").setDescription(text);
    }
}
